...
You can either use `[global_tags]` or using a more advanced configuration as documented [here](https://github.com/XenoStar123/telegraf/blob/master/docs/CONFIGURATION.md).
